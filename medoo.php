...
/**
 * From Medoo Framework Version 0.9.8.3, Copyright 2015, Angel Lai
 * Edited by Ganda
...
class medoo
{
	...
	public function increase($table = null, $columns = array(), $where = array())
	{
	...
	public function decrease($table = null, $columns = array(), $where = array())
	{
		$get_value = $this->get($table, $columns, $where);
		foreach ($columns as $column) {
			$new_value = $get_value[$column] - 1;
